...
function loadAssets() {
	wp_enqueue_style('style', get_stylesheet_directory_uri().'/dist/css/style.css', '', '1.0', 'all');
	wp_enqueue_script('general', get_stylesheet_directory_uri().'/dist/js/general.js', '', '', true);
}
